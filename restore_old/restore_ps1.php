...
if (file_exists($file_log1))
{
    ...
    $psScriptPath = "C:\\sc\\restore_bmw_1.ps1";
 
$query = shell_exec("powershell -command $psScriptPath -user_input1 '$user_input1' -user_input2 '$user_input2' -user_input3 '$user_input3' -user_input4 '$user_input4'< NUL");
